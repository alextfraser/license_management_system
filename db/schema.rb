...
ActiveRecord::Schema[8.0].define(version: 2025_11_01_085744) do
  ...
  create_table "license_assignments", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
